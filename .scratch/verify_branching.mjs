...
// Tier names were "Act N - <name>" before #376 renamed them to
// "Act N · <place name>"; assert on the current names.
checks.push(["tier0 is Act I · The Outer Grove", result.tier0 === "Act I · The Outer Grove"])
checks.push(["tierLate is Act VII · The Echo Verge", result.tierLate === "Act VII · The Echo Verge"])
