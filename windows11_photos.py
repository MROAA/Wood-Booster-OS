...
class Windows11PhotosManager:
    ...
    def __init__(self):
        self.gallery = [
            {"id": 1, "filename": "BoosterWallpaper_4K.png", "resolution": "3840x2160", "size": "4.2 MB", "folder": "Pictures\Wallpapers"},
            {"id": 2, "filename": "QuantumArchitecture.jpg", "resolution": "1920x1080", "size": "1.8 MB", "folder": "Pictures\Screenshots"},
            {"id": 3, "filename": "Win11KernelSchema.png", "resolution": "2560x1440", "size": "2.5 MB", "folder": "Pictures\Saved Pictures"}
        ]
