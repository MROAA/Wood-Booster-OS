 ...
 * Boosterverse
 *
 * Explain Python Code Skill
 *
 * Lukee olemassa olevan .py-tiedoston projektin sisältä File Toolin
 * kautta ja pyytää AI:ta selittämään sen luonnollisella kielellä.
 * Vain luku - ei koskaan kirjoita tai suorita mitään, joten tälle
 * ei tarvita hyväksymiskiertoa (write-python-skillin
 * draft/approve-mallista poiketen).
 *
...
const explainPythonCodeSkill = {
    ...
    description:
        ...
        "asks the AI to explain what it does in plain language.",

    async execute(context) {

        const { filePath, toolBus, explainPythonCode } = context || {}
        ...
        if (!safePath) {
            ...
            return {
                ...
                error:
                    ...
                    "sisäiset .py-tiedostot voi selittää.",
            }
        ...
        const { explanation } = await explainPythonCode({
...
export default explainPythonCodeSkill
