...
vaihe lisää kerroksia, ei rakenna uudestaan.
...
## Vaihe 4 — Yrityksen digitaalinen muisti

Järjestelmä tuntee yrityksen historian. Se löytää aiemmat
ratkaisut, tukee päätöksentekoa, auttaa uusien työntekijöiden
perehdytyksessä.

## Vaihe 5 — Luova työympäristö

Integroidut työkalut kuvien käsittelyyn, videoiden
perusmuokkaukseen, tuotekuvien valmisteluun, somejulkaisujen
luontiin, tarjousmateriaalien tekemiseen, esitysten rakentamiseen.
Tavoite: nopeuttaa päivittäistä sisällöntuotantoa ilman jatkuvaa
ohjelmasta toiseen vaihtamista.
...
Tarkempi lyhyen aikavälin tehtävälista (MVP/V1/V2/V3-tasolla) ei ole
vielä olemassa erillisenä — tämä roadmap kuvaa suuret vaiheet, ei
seuraavaa sprinttiä. Kun seuraava konkreettinen kehitysjakso
suunnitellaan, tarkennetaan tähän mihin vaiheeseen se sijoittuu.
