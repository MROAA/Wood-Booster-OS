...
Tavoitteena on rakentaa käyttöjärjestelmä, joka auttaa käyttäjäänsä työskentelemään rauhallisemmin, tehokkaammin ja laadukkaammin.
...
- Hyvä ohjelmisto säästää käyttäjän aikaa.
- Yrityksen tieto on sen arvokkain digitaalinen omaisuus.
- Tekoälyn tulee vahvistaa ihmisen osaamista, ei korvata sitä.
- Jokaisen ominaisuuden tulee tuottaa todellista hyötyä käyttäjälle.
...
Teknologiat voivat vaihtua.

Ohjelmointikielet voivat vaihtua.

Tekoälymallit voivat vaihtua.

Mutta järjestelmän tarkoitus säilyy.
...
Jos uusi ominaisuus on ristiriidassa Blueprintin periaatteiden kanssa, Blueprint on ensisijainen.

---

# Relationship with Spacemonkey
...
Sen tärkein tehtävä on auttaa käyttäjää saavuttamaan tavoitteensa turvallisesti, tehokkaasti ja mahdollisimman vähällä tarpeettomalla työllä.
...
- Automaatioita rakennetaan vain käyttäjän hyödyksi.
- Käyttäjän data säilyy käyttäjän hallinnassa.
- Järjestelmää kehitetään pitkäjänteisesti, ei hetkellisten trendien mukaan.
- Jokainen julkaisu tekee ohjelmistosta hyödyllisemmän kuin edellinen.
...
Projektin arvo ei muodostu pelkästään sen koodista, vaan siitä tiedosta, kokemuksesta ja käytännöistä, joita järjestelmä auttaa säilyttämään sukupolvelta toiselle.
